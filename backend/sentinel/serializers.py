...
class EmailSubscriberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'email', 'name', 'subscribed_at', 'is_active', 'confirmed']
        read_only_fields = ['id', 'subscribed_at', 'is_active', 'confirmed']
    ...
    def create(self, validated_data):
        ...
        validated_data['unsubscribe_token'] = unsubscribe_token
